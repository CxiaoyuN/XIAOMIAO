export default class AV123Source implements Handle {
  ...
  async getCategory() {
    return [
      { id: "explore/long/q-口", text: "口交" },
      { id: "explore/long/q-对白", text: "对白" },
      { id: "explore/long/q-巨乳", text: "巨乳" },
      { id: "explore/long/q-萝莉", text: "萝莉" },
      { id: "explore/long/q-白虎", text: "白虎" },
      { id: "explore/long/q-吞精", text: "吞精" },
      { id: "explore/long/q-内射", text: "内射" },
      { id: "explore/long/q-自慰", text: "自慰" },
      { id: "explore/long/q-喷水", text: "喷水" },
      { id: "explore/long/q-高潮", text: "高潮" },
      { id: "explore/long/q-Ai", text: "AI" },
      { id: "explore/long/q-极品", text: "极品" },
      { id: "explore/long/q-妹妹", text: "妹妹" },
      { id: "explore/long/q-姐姐", text: "姐姐" },
      { id: "explore/long/q-ts", text: "人妖" }
    ];
  }
